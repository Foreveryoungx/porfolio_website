...
export default function SkillType({ skill, directionLeft }: Props) {
  return (
    <div className={"group relative flex cursor-pointer"}>
      <motion.img
        ...
        className={
          "rounded-full border border-gray-500 object-cover w-24 h-24 xl:w-32 xl:h-32 filter group-hover:grayscale transition duration-300 ease-in-out"
        }
      />
      <div
        className={
